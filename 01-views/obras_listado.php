...
registrarNavegacion('OBRAS - Listado');

// poblarDatableAll(columnas de la tablas, php o ajax, filtro); [reference] 
$filas = poblarDatableAll(array('obra_id', 'obra_nombre', 'obra_fecha_inicio', 'obra_fecha_fin', 'obra_estado'), 'php', 'todos');
?>
...
<head>
  ...
  <title>ADMINTECH | Listado de obras</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><strong>Listado de obras</strong></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <!--  <button type="button" class="col-1 btn btn-success btn-block mb-0 mt-0 mr-1 v-accion-ver-todos" data-accion="vertodos" data-filtro="todos"><i class="fa fa-eye"></i> Todos</button>
              ...
              <button onclick="window.location.href='obras_form.php'" type="button" class="col-1 btn btn-success btn-block mb-0 mt-0 mr-0"><i class="fa fa-plus-circle"></i> Agregar</button>
            </div>
        <div class="row">
          <div class="col-12">
            <div class="card">
...
<script>
  $(function () {
    $("#current_table").DataTable({
      ...
      "columns": [
          { "width": "1%" },    // id 
          { "width": "20%" },    // obra_nombre
          { "width": "10%" },   // obra_fecha_ini
          { "width": "10%" },   // obra_fecha_fin 
          { "width": "10%" },    // obra_estado
          { "width": "5%" }     // acciones
        ], 
       "order": [[0, "desc"], [2, "asc"], [3, "asc"]] // Ordenar por sexta columna y luego por séptima columna (ambas de forma ascendente)
