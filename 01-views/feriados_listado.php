...
registrarNavegacion('FERIADOS - Listado');

$filas = poblarDatableAll(array('id_feriado', 'fecha', 'descripcion', 'estado'), 'php', 'todos');
?>
...
<head>
  ...
  <style>
    ...
    #current_table tbody td.feriados-col-acciones {
      white-space: nowrap;
    }
    ...
    #current_table_wrapper .feriados-filtro-estado {
      width: 180px;
    }
  </style>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><strong>Feriados | Listado</strong></h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row d-flex text-center justify-content-end p-2">
          ...
          <button onclick="window.location.href='feriados_form.php'" type="button" class="col-1 btn btn-success btn-block mb-0 mt-0 mr-1"><i class="fa fa-plus-circle"></i> Agregar</button>
        </div>
        <div class="row">
          <div class="col-12">
            <div class="card mb-2">
  ...
  $(function () {
    $("#current_table").DataTable({
      ...
      "initComplete": function () {
        ...
        var $estadoFiltro = $('<select>', {
          'class': 'form-control form-control-sm feriados-filtro-estado',
          'aria-label': 'Filtrar por estado'
        }).append(
          $('<option>', {value: '', text: 'Todos los estados'}),
          $('<option>', {value: 'Habilitado', text: 'Habilitados'}),
          $('<option>', {value: 'Deshabilitado', text: 'Deshabilitados'})
        );

        $filterContainer.prepend($estadoFiltro);
        $estadoFiltro.on('change', function () {
          api.column(3).search(this.value ? '^' + this.value + '$' : '', true, false).draw();
        });
      }
    });
  });
