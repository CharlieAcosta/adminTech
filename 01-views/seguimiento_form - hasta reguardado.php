    ...
    <div id="collapseVisita" class="collapse show" aria-labelledby="headingVisita" data-parent="#accordionVisita">
      <div class="card-body">
        ...
        <div class="text-center">
          <button type="button" class="btn btn-success mr-2 btn-guardar-visita">Guardar Visita</button>
          <button type="button" class="btn btn-info">Generar Presupuesto</button>
        </div>
