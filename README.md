...
- Para el perfil `Administrativo`, la presentacion del acceso muta de seguimiento tecnico a bandeja OC: en `01-views/panel.php` el modulo se titula `Ordenes de compra`, usa icono `fa-file-invoice` y el badge dice `Pendientes`, en `01-views/layout/navbar_layout.php` el tooltip del acceso tambien se presenta como `Ordenes de compra`, y en `01-views/seguimiento_de_obra_listado.php` el titulo visible de la pantalla cambia a `Ordenes de compra | Listado`. Otros perfiles conservan `Seguimiento de obra`.
